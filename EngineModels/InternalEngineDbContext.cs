...
using WF.Engine.DbModels.EngineModels.PostgreSQL.Internal.Data;
using WF.Engine.DbModels.EngineModels.PostgreSQL.Internal.Models;

namespace WF.Engine.DbModels.EngineModels
{
    public class InternalEngineDbContext : InternalEngineTemplateDbContext
    {
        private readonly string connectionString;

        public InternalEngineDbContext(string connectionString)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<act_id_info>().Property(e => e.value_).HasColumnType("text");
            modelBuilder.Entity<act_ru_task>().Property(e => e.Enabled).HasDefaultValue(false);
